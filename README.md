...
| [Lab 05 — Docker Networking](./lab05_docker_networking/) | Custom bridge network with DNS resolution between containers, demonstrating network isolation and inter-container communication | Custom networks, bridge driver, DNS resolution, network isolation, container communication |
---
